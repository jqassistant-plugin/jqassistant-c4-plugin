...
public class C4DiagramScannerPlugin extends AbstractScannerPlugin<FileResource, C4Descriptor> {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(C4DiagramScannerPlugin.class);
        ...
        if (!path.toLowerCase().endsWith(".puml")) {
            ...
            try {
                try (InputStream is = fileResource.createStream()) {
                    ...
                    if (fileContent.contains("!include <C4/C4_Component>") || fileContent.contains("!include <C4/C4_Container>") || fileContent.contains("!include <C4/C4_Context>")) {
                        return true;
                    }
                }
            } catch (IOException e) {
